...
function Home() {
    ...
    const handleSubmit = async (e) => {
        // e.preventDefault();
        console.log(File)
        // const fl = File.replace('blob:', '')
        // const request = { query: inputValue, file: File };
                ...
                <div className="content-center justify-self-center">
                    <div className="items-center justify-self-center text-info ">
                        <input type="file"
                               ...
                               onChange={(e) => setFile(e.target.files[0] ? URL.createObjectURL(e.target.files[0]) : null)}
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 mt-8">
                <div className="content-center justify-self-center">
                    <div className="form-control w-full max-w-xs ">
                        ...
                        <br/>
                        <textarea className="textarea" placeholder={displayValue} disabled></textarea>
                        <br/>
                        <div>
